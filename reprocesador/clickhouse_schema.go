...
const insertColumns = "event_time, start_time, end_time, event_id, event_type, header, router_ip, router_port, protocol_id, protocol, private_ip, private_port, public_ip, public_port, destination_ip, destination_port, packet_size"
...
func clickHouseInsertURL(baseURL, tableName, queryID string) (string, error) {
...
func clickHouseCreateTableDDL(tableName string) (string, error) {
	if err := validateTableName(tableName); err != nil {
		return "", err
	}
